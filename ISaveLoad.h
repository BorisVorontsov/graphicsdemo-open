...
public:
	...
	virtual void LoadStandartImage(const RECT &aLimit, RECT &aResultDims, HWND hwnd, HDC hdc) = 0;
...
public:
	...
	//void LoadStandartImage( const RECT &aLimit, RECT &aResultDims, HWND hwnd, HDC hdc);
